...
export const mergePDFs      = (files)               => clientMerge(files)   // ✅ client-side
export const splitPDF       = (file,p)              => clientSplit(file,p)   // ✅ client-side
export const rotatePDF      = (file,d,p)            => clientRotate(file,d,p)   // ✅ client-side
export const compressPDF    = (file)                => clientCompress(file)   // ✅ client-side
...
export const pdfToImages    = (file, onProgress)    => clientPdfToImages(file, onProgress)   // ✅ client-side
...
export const deletePages    = (file,p)              => clientDeletePages(file,p)   // ✅ client-side
...
export const pdfToJpg       = (file, onProgress)    => clientPdfToJpg(file, onProgress)   // ✅ client-side
